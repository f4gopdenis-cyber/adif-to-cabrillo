...
def make_qso(rec, sent_exchange="", received_exchange=""):
    ...
    return f"QSO: {freq:>5} {mode:<2} {date} {t} {call:<13} {rs:<3} {sent_exchange:<6} {rec.get('CALL','').strip().upper():<13} {rr:<3} {received_exchange:<6} 0"
...
def convert_file(source, destination, header):
    ...
    skipped = 0
    for rec in records:
        line = make_qso(rec, header["sent_exchange"], header["received_exchange"])
        if line:
...
class App:
    def __init__(self, root):
        ...
        self.callsign = tk.StringVar(value="F4GOP")
        self.power = tk.StringVar(value="HIGH")
        self.category_mode = tk.StringVar(value="CW")
        self.name = tk.StringVar(value="Denis")
        self.address = tk.StringVar()
        self.city = tk.StringVar(value="Normandy")
        self.country = tk.StringVar(value="France")
    ...
    def convert(self):
        ...
        header = {
            ...
            "callsign": self.callsign.get().strip().upper() or "F4GOP",
